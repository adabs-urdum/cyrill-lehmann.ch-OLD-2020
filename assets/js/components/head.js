...
class Head extends Component{
    ...
    componentDidMount(){
        ...
        const camera = new BABYLON.UniversalCamera("camera", new BABYLON.Vector3(0, 0, 500), scene);
        camera.setTarget(BABYLON.Vector3.Zero());
        camera.lowerRadiusLimit = 400;
        camera.upperRadiusLimit = 400;

        const hemisphericLight = new BABYLON.HemisphericLight("hemisphericLight", new BABYLON.Vector3(0, 200, 0), scene);
        hemisphericLight.diffuse = new BABYLON.Color3(1, 1, 1);

        const lightIntensity = 1;
        const spotLightFront = new BABYLON.SpotLight('spotLightFront', new BABYLON.Vector3(0, 0, 400), new BABYLON.Vector3(0, 0, 0), Math.PI * 2, 0, scene);
        spotLightFront.intensity = lightIntensity;
        const spotLightLeft = new BABYLON.SpotLight('spotLightLeft', new BABYLON.Vector3(400, -200, 100), new BABYLON.Vector3(0, 0, 0), Math.PI * 2, 0, scene);
        spotLightLeft.intensity = lightIntensity;
        const spotLightRight = new BABYLON.SpotLight('spotLightRight', new BABYLON.Vector3(-400, -200, 100), new BABYLON.Vector3(0, 0, 0), Math.PI * 2, 0, scene);
        spotLightRight.intensity = lightIntensity;
        const spotLightLower = new BABYLON.SpotLight('spotLightLower', new BABYLON.Vector3(0, -200, 200), new BABYLON.Vector3(0, 0, 0), Math.PI * 2, 0, scene);
    ...
    loadObjects = () => {
        ...
        BABYLON.SceneLoader.ImportMesh("", "../dist/obj/", "head3d.obj", this.state.scene, function (meshes, particleSystems, skeletons) {
            ...
            */
            ...
            // both irises
            const irisRight = meshes[3];
            irisRight.material.diffuseColor = new BABYLON.Color3(1 / 255 * 45, 1 / 255 * 22.5, 0);
            ...
            meshes[1].parent = pivotEyeRight;
            meshes[2].parent = pivotEyeRight;
            ...
            meshes[5].parent = pivotEyeLeft;
            meshes[6].parent = pivotEyeLeft;
