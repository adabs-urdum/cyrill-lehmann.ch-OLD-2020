    ...
    constructor(props){
        ...
        this.state = {
            projects: [
                {
                    name: 'robojelly',
                    description: 'a cute robotic jellyfish created purely with css. using javascript for eye movement',
                ...
                {
                    name: 'wobble head',
                    description: 'scanned my head using an iphone, then added head turning either using mouse position, gyroscope or face tracking through a camera',
                ...
                {
                    name: 'rogue cards',
                    description: 'started a rogue like card deckbuilder using react and babylon. inspired by slay the spire. abandoned for now.',
                ...
                {
                    name: 'rubiks clus',
                    description: 'my first experiment using three.js and our clus team photos',
    ...
    render(){
        ...
        const projectsJsx = this.state.projects.map(project => {
            ...
            const tagsJsx = project.tags.map(tag => {
                return(
                    <li className="what__tagListEntry" key={tag.replace(' ', '')}>{ tag }</li>
                );
            });
            ...
            return(
                <li className="what__listEntry" key={ project.name.replace(' ', '') }>
                    ...
                    <a className="what__project" target="_blank" href={ project.link } style={{
        ...
        return(
            <section className="what">
                <Link to="/" className="button what__anchorBack">back</Link>
